...
export const ProfileImage = ({
  ...
  return (
    <div className="w-[60px] h-[60px] md:w-[100px] md:h-[100px] opacity-80 overflow-hidden rounded-full border-[3px] border-[rgba(59,59,59,0.6)] flex-none relative">
      <img
        ...
        style={{ filter: "saturate(0.2) sepia(0.46)" }}
      />
    </div>
  );
};
...
export const TestimonialCard = ({
  ...
  layout = false,
  onCardClose = () => {},
  backgroundImage = "https://images.unsplash.com/photo-1528458965990-428de4b1cb0d?q=80&w=800&auto=format&fit=crop",
}: {
  testimonial: iTestimonial;
  index: number;
  layout?: boolean;
  ...
  return (
    <>
          ...
          <div className="fixed inset-0 h-screen overflow-hidden z-50">
            ...
            >
              ...
              <motion.p
                ...
                className="px-0 md:px-20 text-[#1f1b1d]/70 text-lg font-thin italic underline underline-offset-8 mt-4"
              >
              ...
              <div className="py-8 text-[#1f1b1d]/70 px-0 md:px-20 text-2xl lowercase font-thin leading-snug tracking-wide">
                <span className="text-4xl leading-none mr-2 opacity-40">"</span>
      ...
      >
        <div className="rounded-3xl bg-gradient-to-b from-[#f2f0eb] to-[#fff9eb] h-[320px] md:h-[400px] w-56 md:w-72 overflow-hidden flex flex-col items-center justify-center relative z-10 shadow-md">
          ...
          <motion.p
            layoutId={layout ? `title-${testimonial.name}` : undefined}
            className="text-[#1f1b1d]/70 text-base md:text-lg font-normal text-center italic mt-3 lowercase px-4"
          >
          ...
          <motion.p
            layoutId={layout ? `category-${testimonial.name}` : undefined}
            className="text-[#1f1b1d]/70 text-base md:text-lg font-thin italic text-center mt-3 lowercase"
          >
            {testimonial.name}.
          </motion.p>

          <motion.p
            className="text-[#1f1b1d]/60 text-xs font-thin italic text-center mt-1 lowercase underline underline-offset-8 decoration-1"
          >
